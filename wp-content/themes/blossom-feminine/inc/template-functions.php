...
function blossom_feminine_page_start(){
    ?>
    <div id="page" class="site"><a aria-label="skip to content" class="skip-link" href="#content"><?php esc_html_e( 'Skip to Content', 'blossom-feminine' ); ?></a>
    <?php
}
endif;
...
function blossom_feminine_header(){ 
    ...
    <header id="masthead" class="site-header wow fadeIn" data-wow-delay="0.1s" itemscope itemtype="http://schema.org/WPHeader">
		...
		<div class="header-b">
			<div class="container">
				<button aria-label="primary menu toggle button" id="primary-toggle-button"><i class="fa fa-bars"></i><?php esc_html_e( 'Navigation', 'blossom-feminine' ); ?></button>
