...
function blossom_feminine_scripts() {
    ...
    wp_enqueue_script( 'owl-carousel-aria', get_template_directory_uri() . '/js' . $build . '/owl.carousel.aria' . $suffix . '.js', array( 'jquery', 'owl-carousel' ), '2.0.0', true );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><?php printf( __( '%1$s is now installed and ready to use. Click below to see theme documentation, plugins to install and other details to get started.', 'blossom-feminine' ), $name ) ; ?></p>
...
if( ! function_exists( 'blossom_feminine_admin_notice_display' ) ) :
/**
 * Adding Getting Started Page in admin menu
 */
function blossom_feminine_admin_notice_display(){
    update_option( 'blossom-feminine-update-notice', false );
}
endif;
add_action( 'after_switch_theme', 'blossom_feminine_admin_notice_display' );