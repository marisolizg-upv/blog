...
if ( ! defined( 'BLOSSOM_FEMININE_THEME_VERSION' ) && ! defined( 'BLOSSOM_FEMININE_THEME_NAME' ) && ! defined( 'BLOSSOM_FEMININE_THEME_TEXTDOMAIN' ) ) {
	$theme_data = wp_get_theme();	
	define ( 'BLOSSOM_FEMININE_THEME_VERSION', $theme_data->get( 'Version' ) );
	define ( 'BLOSSOM_FEMININE_THEME_NAME', $theme_data->get( 'Name' ) );
	define ( 'BLOSSOM_FEMININE_THEME_TEXTDOMAIN', $theme_data->get( 'TextDomain' ) );
}
